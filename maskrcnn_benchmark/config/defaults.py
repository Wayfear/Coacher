...
_C.MODEL.ROI_RELATION_HEAD.EMBED_DIM = 300
...
_C.MODEL.EXRERNAL_KNOWLEDGE = CN()
_C.MODEL.EXRERNAL_KNOWLEDGE.PATH = True
_C.MODEL.EXRERNAL_KNOWLEDGE.PATH_DIM = 256
_C.MODEL.EXRERNAL_KNOWLEDGE.CONTEXT_LAYER = 1
_C.MODEL.EXRERNAL_KNOWLEDGE.TOPK = False
_C.MODEL.EXRERNAL_KNOWLEDGE.POSITION_EMBEDDING = True
_C.MODEL.EXRERNAL_KNOWLEDGE.NEIGHBOR = True
_C.MODEL.EXRERNAL_KNOWLEDGE.FAST_RATIO = 5
_C.MODEL.EXRERNAL_KNOWLEDGE.GRAPH_WITH_NEIGHBOR = False
_C.MODEL.EXRERNAL_KNOWLEDGE.PURE_NEIGHBOR = False
_C.MODEL.EXRERNAL_KNOWLEDGE.GNN_MODE = "DGCNN"
_C.MODEL.EXRERNAL_KNOWLEDGE.GNN_LAYER = 2
# sum, max, attention
_C.MODEL.EXRERNAL_KNOWLEDGE.PATH_FUSION = "attention"
# concat, add. dot
_C.MODEL.EXRERNAL_KNOWLEDGE.PATH_NEI_FUSION = "concat"

_C.MODEL.EXRERNAL_KNOWLEDGE.ZERO_SHOT_PATH = ""
